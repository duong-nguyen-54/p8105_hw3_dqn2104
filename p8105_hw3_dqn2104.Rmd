...
Here, we can see that after combining common data in both data, there are only 94 observations, while there are more data both baseline and amyloid. That indicates that there are unique data that only resides in baseline, as well as there are unique ones that only are present in amyloid. 
